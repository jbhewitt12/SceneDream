...
All you'll need to get it working is an OpenAI API key with active billing or available prepaid credits, plus a text based story. You don't need to be technically savvy to use it, because it's all done through a web interface.
